...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _getChatbotResponse(String query) async {
    try {
      ...
      print(
          'https://api-hacknchill.onrender.com/chatUser?text="talk in english, and answer this: "+${Uri.encodeComponent(query)}');
      ...
      child: Row(
        ...
        children: <Widget>[
          isUserMessage
              ? SizedBox()
              : Image.asset(
                  'assets/robot.png', // Use the image asset
                  width: 40, // Adjust the width as needed
                  height: 40, // Adjust the height as needed
                ),
          Container(
